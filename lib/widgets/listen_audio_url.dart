...
//   // isPlayed 가 바뀔 때마다 호출해서, 위젯을 새로 만들 변수
//   late VoidCallback _playerListenerCallback;
//   // url 이 주어졌으면 참. url 이 없으면, 재생 버튼 비활성화
//   ValueNotifier<bool> isAudioUrlDefined = ValueNotifier(true);
...
//   void didUpdateWidget(ListenAudioUrl oldWidget) {
//     super.didUpdateWidget(oldWidget);
//     if (widget.urlPath.isNotEmpty && widget.urlPath != oldWidget.urlPath) {
//       _prepareAudio();
//       isAudioUrlDefined.value = true;
//     } else {
//       isAudioUrlDefined.value = false;
//     }
//   }
...
//     // isPlayed 를 참조해서, 그게 바뀌면 다시 빌드
//     return ValueListenableBuilder<bool>(
//       valueListenable: isAudioUrlDefined,
//       builder: (BuildContext context, bool isPlayed, Widget? child) {
//         return ValueListenableBuilder<bool>(
//           valueListenable: widget.isPlayed,
//           builder: (BuildContext context, bool isPlayed, Widget? child) {
//             // 재생/정지 버튼 구현
//             return IconButton(
//               onPressed: isAudioUrlDefined.value
//                   ? () {
//                       widget.isPlayed.value = !widget.isPlayed.value;
//                     }
//                   : null,
